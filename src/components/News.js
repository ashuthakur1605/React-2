...
const News = (props) => {
  ...
  useEffect(() => {
    document.title = `${capitalizeFirstLetter(props.category)}-RealTime-News`;
    updateNews();
  }, [])
  ...
  return (
    <>
      ...
      <h1 className='text-center ' style={{ margin: '45px 0px' ,marginTop:'90px' }}>News - Today's Top {capitalizeFirstLetter(props.category)} HeadLines</h1>
      {loading && <Spinner />}
      <InfiniteScroll
